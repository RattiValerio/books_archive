...
@section('header-content-add')
    <a href="{{route('authors.create')}}" class="btn btn-primary"><i class="bi bi-plus-circle"></i> Add an author</a>
@endsection
        ...
        <div class="col-md-12">
            <table class="table table-striped table-hover">
                ...
                <tr>
                    ...
                    <th scope="col" class="w-25">Date of birth</th>
                    <th scope="col" class="w-auto text-end">Actions</th>
                </tr>
                </thead>
                <tbody>
                    @forelse($authors as $index => $author)
                        @include('author.partial.author-block')
                    @empty
